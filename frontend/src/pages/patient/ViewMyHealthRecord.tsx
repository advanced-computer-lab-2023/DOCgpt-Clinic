              ...
              <CardContent style={{ flex: 1 }}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    ...
                    {healthRecord.MedicalHistory.PastMedicalConditions.length >
                    0 ? (
                      <ul>
            ...
            <CardContent style={{ flex: 1 }}>
              <Grid container spacing={2}>
                <Grid item xs={12}>
                  ...
                  {healthRecord.MedicationList.CurrentMedications.Names.length >
                  0 ? (
                    <ul>
                ...
                <Grid item xs={12}>
                  ...
                  {healthRecord.MedicationList.PastMedications.Names.length >
                  0 ? (
                    <ul>
                      {healthRecord.MedicationList.PastMedications.Names.map(
                        (item, index) => (
                          <li key={index}>
                            {item.trim() !== "" ? item : "No Past Medications"}
                          </li>
                        )
                      )}
                    </ul>
          ...
          >
            ...
            <CardContent style={{ flex: 1 }}>
              ...
              <Grid item xs={6}>
                ...
                {healthRecord.MedicationList.CurrentMedications.Prescriptions.map(
                  (item, index) => (
                    <div key={index}>
                      <Typography>
                        Prescription:{" "}
              ...
              <Grid item xs={6}>
                ...
                {healthRecord.MedicationList.PastMedications.Prescriptions.map(
                  (item, index) => (
                    <div key={index}>
                      <Typography>
                        Prescription:{" "}
                  ...
                  {healthRecord.GeneralComments.length > 0 ? (
                    <ul>
                      {healthRecord.GeneralComments.map((item, index) => (
                        <li key={index}>
                          {item.trim() !== "" ? item : "No Comments Entered"}
                        </li>
                      ))}
                    </ul>
                  ) : (
