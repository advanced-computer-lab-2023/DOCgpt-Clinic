...
//   const navigate = useNavigate();
//   const handleSignUp = () => {
//     navigate("/signupPatient"); // Navigate to the '/signup' page
//   };
...
//       <AppBar
//         position="static"
//         style={{ marginBottom: "50px", background: theme.palette.blue.main }}
//       >
//         <Toolbar style={{ display: "flex", justifyContent: "space-between" }}>
//           <Typography variant="h6">el7a2ni</Typography>
//           <ButtonGroup variant="text">
//             <Button
//               style={{ color: theme.palette.customGrey.light }}
...
//                 Voluptatum fugiat explicabo reprehenderit optio vel sunt
//                 excepturi obcaecati possimus ipsa consectetur praesentium enim
//                 nesciunt cumque delectus laudantium, vitae, laboriosam odio
//                 placeat!
//               </Typography>
//             </Grid>
//           </Grid>
...
//         container
//         id="contactUsSection"
//         style={{ background: theme.palette.blue.main }}
//       >
//         <Grid item xs={4} style={{ display: "flex" }}>
//           <Typography
//             variant="h6"
...
//             variant="middle"
//             flexItem
//             style={{ background: theme.palette.customGrey.light }}
//           />
//           <Typography
//             variant="h6"
//             style={{
...
import React from "react";
import HealthProblems from "../components/views/HealthProblems";
import Questions from "../components/views/AnyQuestions";
//import AppFooter from "../components/views/AppFooter";
import Quality from "../components/views/QualityHealth";
import Options from "../components/views/WebOptions";
import Connect from "../components/views/ConnectDr";
import Family from "../components/views/Familyy";
