...
import MyPatients from "./MyPatients";
    ...
    const user =localStorage.getItem("myPatient");
    useEffect(() => {
        ...
        try {
            ...
            const patientAppointments = data.filter((appointment: any) => appointment.patient === user);
