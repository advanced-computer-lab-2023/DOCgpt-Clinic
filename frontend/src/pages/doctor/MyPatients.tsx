import { Container, IconButton, Stack, Switch, TextField, Typography } from "@mui/material";
...
//THE LINK TO BACK
    ...
    async function searchPatients() {
        try {
            ...
            const token=localStorage.getItem("authToken")
            const response = await axios.get(`/routes/doctors/searchPatient?patientName=${nameSearchTerm}`, {
                headers:{
                    Authorization:`Bearer ${token}`
                }});
            if(response){
