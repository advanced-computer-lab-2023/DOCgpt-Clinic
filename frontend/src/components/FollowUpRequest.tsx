  ...
  return (
    <Container>
          ...
          <Grid container direction="column">
            ...
            >
              <IconButton
                ...
                style={{
                  color: status === 'pending' ? 'rgba(0, 150, 136, 0.7)' : 'grey',
                  marginRight: "10px",
                  fontSize: "3rem",
              ...
              <IconButton
                ...
                style={{ color: status === 'pending' ? 'red' : 'grey', marginRight: "10px", fontSize: "3rem" }}
                disabled={status!=='pending'}
              >
      ...
      <Dialog open={confirmationDialogOpen} onClose={handleConfirmationDialogClose}>
        <DialogTitle>{`Confirm ${actionType === "accept" ? "Accept" : "Reject"} Request`}</DialogTitle>
        <DialogContent>
          <Typography>
            {`Are you sure you want to ${actionType === "accept" ? "accept" : "reject"} this follow-up request?`}
          </Typography>
        </DialogContent>
        <DialogActions>
