...
const ViewPAppointments: React.FC<ViewMyAppointmentsProps> = ({username}) => {
    ...
    const fetchAppointments = async () => {
        ...
        try {
        const response = await axios.get(`/api/appointment/appP?username=${username}`);
...
export default ViewPAppointments;